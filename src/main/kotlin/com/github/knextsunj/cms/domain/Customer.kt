...
@NamedQueries(
    ...
    NamedQuery(name = "Customer.findAllByActiveStatus", query = "select customer from Customer customer where customer.customerStatus.name='ACTIVE' and customer.deleted='N'")
)
@DynamicUpdate
open class Customer {
    ...
    @Column(name = "dob")
    open var dateOfBirth: LocalDateTime? = null;
